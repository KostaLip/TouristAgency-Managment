...
import { HOTEL_URL, TURISTICKA_AGENCIJA_URL } from '../constants';
...
export class HotelService {
  ...
  public updateHotel(hotel: Hotel): Observable<any> {
    return this.httpClient.put(`${HOTEL_URL}/id/${hotel.id}`, hotel);
  }

  public deleteHotel(hotelId: number): Observable<any> {
    return this.httpClient.delete(`${HOTEL_URL}/id/${hotelId}`, {responseType: 'text'});
  }
