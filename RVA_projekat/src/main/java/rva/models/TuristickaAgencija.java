...
public class TuristickaAgencija implements Serializable{
	...
	@Id
	@SequenceGenerator(name = "TuristickaAgencija_SEQ_GENERATOR", sequenceName = "turisticka_agencija_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TuristickaAgencija_SEQ_GENERATOR")
	private int id;
	...
	@OneToMany(mappedBy = "agencija", cascade = CascadeType.REMOVE)
	@JsonIgnore
